...
unset($__errorArgs, $__bag); ?>
                        ...
                        <p class="mb-2">Already have an account? <a href="<?php echo e(route('login')); ?>" class="f-w-400">Log in</a>
                        </p>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\dynamic_shop\resources\views/auth/register.blade.php ENDPATH**/ ?>