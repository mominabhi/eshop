<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed">
    <div class="m-header">
        ...
        <a href="index.html" class="b-brand">
            <img src="{{ asset('assets/backend/images/logo.svg') }}" alt="" class="logo images" />
            <img src="{{ asset('assets/backend/images/logo-icon.svg') }}" alt="" class="logo-thumb images" />
        </a>
    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ asset('assets/backend/images/user/avatar-1.jpg') }}"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ asset('assets/backend/images/user/avatar-2.jpg') }}"
                                        alt="Generic placeholder image" />
                                    <div class="media-body">
                                        <p>
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{ asset('assets/backend/images/user/avatar-1.jpg') }}" class="img-radius"
